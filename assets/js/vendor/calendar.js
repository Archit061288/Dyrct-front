...
define(['angularAMD', 'moment'], function(angularAMD, moment) {
    ...
    angular.module('ui.calendar', [])
            ...
            .directive('uiCalendar', ['uiCalendarConfig','$rootScope', function(uiCalendarConfig,$rootScope) {
                    return {
                        restrict: 'A',
                            ...
                            scope.initCalendar = function() {
                                ...
                                options.viewRender = (function() {
                                    return function(view, element) {
                                        console.log(view)
                                       $rootScope.$broadcast("monthChange",view)
                                    }
                                })();
                                calendar.fullCalendar(options);
                                var date = $.fullCalendar.moment(options.setDate);
