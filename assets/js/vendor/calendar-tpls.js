...
.controller('ui.rCalendar.CalendarController', ['$scope', '$attrs', '$parse', '$interpolate', '$log', 'dateFilter', 'calendarConfig', function ($scope, $attrs, $parse, $interpolate, $log, dateFilter, calendarConfig) {
    ...
    var self = this,
        ...
        angular.forEach(['formatDay', 'formatDayHeader', 'formatDayTitle', 'formatWeekTitle', 'formatMonthTitle','formatMonthYear',
        ...
        $scope.$watch('calendarMode', function(newValue, oldValue, scope) {
         console.log(newValue, oldValue,self);
         $scope.$emit("calenderInit",self)
        ...
        $scope.move = function (direction) {
            ...
            self.refreshView();
            $scope.$emit("schedulermonth",self);
        };
...
.directive('calendar', function () {
    ...
    return {
        ...
        link: function (scope, element, attrs, ctrls) {
            ...
            scope.$on('refreshView', function (event, direction) {
        ...
        link: function (scope, element, attrs, ctrls) {
            ...
            function getDates(startDate, n) {
                ...
                ctrl._refreshView = function () {
                    ...
                    scope.$parent.year = dateFilter(headerDate, ctrl.formatMonthYear);
...
angular.module("template/rcalendar/calendar.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/calendar.html",
    ...
    "    <div class=\"col-lg-6 col-xs-8 month-view\">\n" +
    "        <div class=\"nav-left\">\n" +
